...
import { FiEdit, FiSave, FiX, FiRefreshCw } from "react-icons/fi";
      ...
      <StyledSection>
        <StyledCard>
          ...
          <Group justify="center">
            <Button leftSection={<FiRefreshCw size={16} />} onClick={refreshData}>
              Retry
            </Button>
          </Group>
        </StyledCard>
    ...
    <StyledSection>
      <StyledCard>
          ...
          <div>
            ...
            {data.items.map(item => (
              <Group key={item.id} align="flex-start">
                <div style={{ flex: 1 }}>
                  <EditableItem item={item} onUpdate={handleItemUpdate} isEditing={isEditing} />
                </div>
                {isEditing && (
                  <Button
                    size="compact-sm"
        ...
        <ButtonGroup justify={isEditing ? "space-between" : "flex-start"}>
          {!isEditing ? (
            <Button leftSection={<FiEdit size={16} />} onClick={startEdit} variant="filled">
              Edit
            </Button>
          ) : (
            <>
